...
public class GridAdapter extends RecyclerView.Adapter<LinearViewHolder> {
    ...
    public LinearViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new LinearViewHolder(layoutInflater.inflate(R.layout.item_grid_layout, parent, false));
    }
